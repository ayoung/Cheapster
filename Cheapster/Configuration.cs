...
namespace Cheapster
{
	public static class Configuration
	{
		...
		public const string DB_TEMP_ZIP_FILENAME = "backup.zip";
		...
		public static readonly string USER_DB_TEMP_ZIP_PATH;
		public static readonly string USER_DB_TEMP_DB_PATH;
		...
		static Configuration()
		{
			...
			USER_DB_TEMP_ZIP_PATH = Path.Combine(TEMP_FOLDER, DB_TEMP_ZIP_FILENAME);
			USER_DB_TEMP_DB_PATH = Path.Combine(TEMP_FOLDER, USER_DB_FILENAME);
